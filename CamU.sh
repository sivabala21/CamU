#!/bin/bash
# CamU v2.0
# coded by:https://github.com/BOT-CODER/CamU.git
...
sed 's+forwarding_link+'$link'+g' CamU.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' CamU.html > index2.html
